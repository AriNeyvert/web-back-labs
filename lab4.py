...
users = [
    ...
    {'login': 'vika', 'password': '666', 'name': 'Виктория Иванова', 'gender': 'женский'},
    {'login': 'ira', 'password': '777', 'name': 'Ирина Сидорова', 'gender': 'женский'},
]
...
def edit_user():
    ...
    # Обновление логина в сессии если он изменился
